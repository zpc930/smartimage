...
{
    public class ImageChannel_Template : ImageChannel<TPixel>
    {
        public ImageChannel_Template():base(1,1)
        {
        }
        ...
        {
            if (src.Length != dst.Length) throw new InvalidOperationException("The two channels are not the same length.");
